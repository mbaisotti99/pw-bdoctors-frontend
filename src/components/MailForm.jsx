            ...
            <div>
                <div className="mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        className={`form-control ${(formData.nome_utente.length < 3 && popup) && "error"}`}
                        name="nome_utente"
                        id="nome_utente"
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        className={`form-control ${(formData.email_utente.length < 3 && popup) || (formData.email_utente.length >= 3 && !checkMail(formData.email_utente)) ? "error" : ""}`}
                        name="email_utente"
                        id="email_utente"
                ...
                <textarea
                    className={`mailTxt form-control mb-4 ${(formData.text.length < 3 && popup) && "error"}`}
                    name="text"
                    value={formData.text}
                    onChange={onMailChange}
